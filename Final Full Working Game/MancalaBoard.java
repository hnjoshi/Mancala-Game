...
public class MancalaBoard 
{
   ...
   int undoCounter2 = 0; 
	...
	public void makeBoard(BoardTheme abc)
	{
		...
		{
			player1Pit[i] = new pitIcon(100, 100, 100, startingStones, (Shape)myTheme.myShape(), myTheme.getPitColor(), myTheme.getMancalaColor());
		}*/
		...
		{	
            ...
            String temp = notifyText.getText(); 
            
            if(p1 && temp.contains("Free") && undoCounter1<3 && moveStonesCall)
            {
               for(int i = 0 ; i<14; i++)
               {
            ...
            else if(p2 && temp.contains("Free") && undoCounter2<3 
                    && moveStonesCall)
            {
               for(int i = 0 ; i<14; i++)
               {
            ...
            else if(p1 && !temp.contains("Free") && undoCounter2<3 
                    && moveStonesCall)
            {
               for(int i = 0 ; i<14; i++)
               {
            ...
            else if (p2 && !temp.contains("Free") && undoCounter1<3
                    && moveStonesCall)
            {
               for(int i = 0 ; i<14; i++)
               {
